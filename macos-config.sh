...
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText \
    "Found this computer? Please contact me at kazettique@gmail.com ."
...
# * My trackpad config
defaults -currentHost write NSGlobalDomain com.apple.trackpad -dict \
  Clicking -int 0 \
  DragLock -int 0 \
  Dragging -int 0 \
...
defaults write NSGlobalDomain AppleLanguages -array "en-TW" "zh-Hant-TW" "ja-TW" "es-TW"
...
defaults write com.apple.screencapture location -string "/Users/${USER}/Downloads"
...
defaults write NSGlobalDomain NSProviderIdentifier -string "com.google"
